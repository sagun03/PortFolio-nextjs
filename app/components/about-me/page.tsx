...
// const AboutMe = () => {
//   const [introSectionOpen, setIntroSectionOpen] = useState(true);
//   const [experienceSectionOpen, setExperienceSectionOpen] = useState(false);

//   const toggleIntroSection = () => {
//     setIntroSectionOpen((prev) => !prev);
//     setExperienceSectionOpen(false);
//   };

//   const toggleExperienceSection = () => {
//     setExperienceSectionOpen((prev) => !prev);
//     setIntroSectionOpen(false);
//   };
...
//               <span
//                 className={`cursor-pointer underline pb-2 ${
//                   introSectionOpen ? 'text-primary' : ''
//                 }`}
//                 onClick={toggleIntroSection}
//               >
//                 Introduction
//               </span>
//             </h2>
//             {introSectionOpen && <IntroSection />}
//           </div>
//         </section>
...
//             <span
//               className={`cursor-pointer underline pb-2 ${
//                 experienceSectionOpen ? 'text-primary' : ''
//               }`}
...
//             </span>
//           </h2>
//           {experienceSectionOpen && <Experience />}
//         </section>
//       </div>
//     </main>
//   );
